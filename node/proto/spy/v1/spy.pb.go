...
import (
	...
	reflect "reflect"
	sync "sync"
	v1 "wormhole/node/proto/publicrpc/v1"
)
...
func (x *EmitterFilter) Reset() {
	*x = EmitterFilter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_spy_v1_spy_proto_msgTypes[0]
...
func (*EmitterFilter) Descriptor() ([]byte, []int) {
	return file_proto_spy_v1_spy_proto_rawDescGZIP(), []int{0}
}
...
func (x *FilterEntry) Reset() {
	*x = FilterEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_spy_v1_spy_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FilterEntry) Descriptor() ([]byte, []int) {
	return file_proto_spy_v1_spy_proto_rawDescGZIP(), []int{1}
}
...
func (x *SubscribeSignedVAARequest) Reset() {
	*x = SubscribeSignedVAARequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_spy_v1_spy_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SubscribeSignedVAARequest) Descriptor() ([]byte, []int) {
	return file_proto_spy_v1_spy_proto_rawDescGZIP(), []int{2}
}
...
func (x *SubscribeSignedVAAResponse) Reset() {
	*x = SubscribeSignedVAAResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_spy_v1_spy_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SubscribeSignedVAAResponse) Descriptor() ([]byte, []int) {
	return file_proto_spy_v1_spy_proto_rawDescGZIP(), []int{3}
}
...
var File_proto_spy_v1_spy_proto protoreflect.FileDescriptor

var file_proto_spy_v1_spy_proto_rawDesc = []byte{
	0x0a, 0x16, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x70, 0x79, 0x2f, 0x76, 0x31, 0x2f, 0x73,
	0x70, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x73, 0x70, 0x79, 0x2e, 0x76, 0x31,
	...
	,
	...
	0x3a, 0x01, 0x2a, 0x30, 0x01, 0x42, 0x22, 0x5a, 0x20, 0x77, 0x6f, 0x72, 0x6d, 0x68, 0x6f, 0x6c,
	0x65, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x70, 0x79,
	0x2f, 0x76, 0x31, 0x3b, 0x73, 0x70, 0x79, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_proto_spy_v1_spy_proto_rawDescOnce sync.Once
	file_proto_spy_v1_spy_proto_rawDescData = file_proto_spy_v1_spy_proto_rawDesc
)

func file_proto_spy_v1_spy_proto_rawDescGZIP() []byte {
	file_proto_spy_v1_spy_proto_rawDescOnce.Do(func() {
		file_proto_spy_v1_spy_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_spy_v1_spy_proto_rawDescData)
	})
	return file_proto_spy_v1_spy_proto_rawDescData
}

var file_proto_spy_v1_spy_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_spy_v1_spy_proto_goTypes = []interface{}{
...
var file_proto_spy_v1_spy_proto_depIdxs = []int32{
...
func init() { file_proto_spy_v1_spy_proto_init() }
func file_proto_spy_v1_spy_proto_init() {
	if File_proto_spy_v1_spy_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_spy_v1_spy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_spy_v1_spy_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_spy_v1_spy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_spy_v1_spy_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_spy_v1_spy_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_spy_v1_spy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_spy_v1_spy_proto_goTypes,
		DependencyIndexes: file_proto_spy_v1_spy_proto_depIdxs,
		MessageInfos:      file_proto_spy_v1_spy_proto_msgTypes,
	}.Build()
	File_proto_spy_v1_spy_proto = out.File
	file_proto_spy_v1_spy_proto_rawDesc = nil
	file_proto_spy_v1_spy_proto_goTypes = nil
	file_proto_spy_v1_spy_proto_depIdxs = nil
}
